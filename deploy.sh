...
# git push -f git@gitee.com:muyaCode/tanggang_rust.git main:gh-pages # 发布到Gitee
git push -f git@github.com:muyaCode/tanggang_rust.git main:gh-pages # 发布到GitHub
